    package io.fizz.gdpr.job.anonymize.elasticsearch.reportedmessages;
...
public class Executor extends AbstractExecutor {
    ...
    public int run(String[] args) {
        ...
        try {
            final String messagesIndex = configService.get("elasticsearch.reportedmessages.index");
    ...
    private void anonymize(final UpdateByQueryRequest aRequest,
        ...
        queryBuilder.must(QueryBuilders.termsQuery("reportedUserId", aActorIds.toArray(new String[0])));
        ...
        aRequest.setScript(
                new Script(
                        ...
                        "ctx._source.reportedUserId = 'fizz_anonymized'",
