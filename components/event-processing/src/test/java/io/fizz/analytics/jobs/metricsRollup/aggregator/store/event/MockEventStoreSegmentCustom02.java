...
public class MockEventStoreSegmentCustom02 extends AbstractMockTableDataSource {
    public MockEventStoreSegmentCustom02(SparkSession aSpark) {
        super(aSpark);
    }
    ...
    private static final String VALUE_CUSTOM02_A = "testC";
    private static final String VALUE_CUSTOM02_B = "testD";
        ...
        return new ArrayList<Row>() {
            {
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("1").setAppId(VALUE_APP_A).setUserId(VALUE_USER_A)
                        ...
                        .setCustom02(VALUE_CUSTOM02_A).setCustom01("F").setFields("{}").setAge(VALUE_AGE_A)
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("2").setAppId(VALUE_APP_A).setUserId(VALUE_USER_A)
                        ...
                        .setCustom01("D").setCustom02(VALUE_CUSTOM02_A).setCustom03("F").setFields("{\"len\":10}").setAge(VALUE_AGE_A)
                        .setYear("2018").setMonth("5").setDay("8").get());
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("3").setAppId(VALUE_APP_A).setUserId(VALUE_USER_B).setSessionId("session_2")
                        ...
                        .setPlatform("android").setBuild("build_2").setCustom01("D").setCustom02(VALUE_CUSTOM02_A).setCustom03("F")
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("5").setAppId(VALUE_APP_A).setUserId(VALUE_USER_C).setSessionId("session_3")
                        .setType(EventType.SESSION_STARTED.value()).setVersion(AbstractDomainEvent.VERSION).setOccurredOn(VALUE_MESSAGE_TS)
                        .setPlatform("android").setBuild("build_2").setCustom01("D").setCustom02(VALUE_CUSTOM02_B).setCustom03("F")
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("7").setAppId(VALUE_APP_A).setUserId(VALUE_USER_A).setSessionId("session_1")
                        ...
                        .setPlatform("android").setBuild("build_2").setCustom01("D").setCustom02(VALUE_CUSTOM02_A).setCustom03("F").setAge(VALUE_AGE_A)
                        .setYear("2018").setMonth("5").setDay("8").get());
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("8").setAppId(VALUE_APP_A).setUserId(VALUE_USER_B).setSessionId("session_2")
                        .setType(EventType.NEW_USER_CREATED.value()).setVersion(AbstractDomainEvent.VERSION).setOccurredOn(VALUE_MESSAGE_TS)
                        .setPlatform("android").setBuild("build_2").setCustom01("D").setCustom02(VALUE_CUSTOM02_B).setCustom03("F").setAge(VALUE_AGE_B)
                        .setYear("2018").setMonth("5").setDay("8").get());
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("10").setAppId(VALUE_APP_A).setUserId(VALUE_USER_A).setSessionId("session_1")
                        ...
                        .setPlatform("ios").setBuild("build_1").setCustom01("A").setCustom02(VALUE_CUSTOM02_A).setCustom03("C").setAge(VALUE_AGE_A)
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("13").setAppId(VALUE_APP_A).setUserId(VALUE_USER_A).setSessionId("session_1")
                        ...
                        .setPlatform("ios").setBuild("build_1").setCustom01("A").setCustom02(VALUE_CUSTOM02_A).setCustom03("C")
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("16").setAppId(VALUE_APP_A).setUserId(VALUE_USER_C).setSessionId("session_3")
                        ...
                        .setCustom01("D").setCustom02(VALUE_CUSTOM02_A).setCustom03("F")
    ...
    protected Map<MetricValidator.Key, MetricValidator> validatorsFactory() {
        return new HashMap<MetricValidator.Key,MetricValidator>() {
            {
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.USER_SESSIONS_MONTHLY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.USER_SESSIONS_MONTHLY.value()),
                        new MetricValidator().count(1.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.ACTIVE_USERS_MONTHLY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.ACTIVE_USERS_MONTHLY.value()),
                        new MetricValidator().count(1.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.USER_SESSIONS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.USER_SESSIONS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.ACTIVE_USERS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.ACTIVE_USERS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );

                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.NEW_USERS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.NEW_USERS_MONTHLY.value()),
                        new MetricValidator().count(2.0)
                );

                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.NEW_USERS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.NEW_USERS_MONTHLY.value()),
                        new MetricValidator().count(1.0)
                );

                //Active Paying User
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );

                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );

                //-- actions
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.CHAT_MSGS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.CHAT_MSGS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.CHAT_MSGS_MONTHLY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.CHAT_MSGS_MONTHLY.value()),
                        new MetricValidator().count(1.0)
                );

                //sentiment score mean
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.SENTIMENT_DAILY.value()),
                        new MetricValidator().mean(0.0).max(0.5).min(-0.5)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.SENTIMENT_DAILY.value()),
                        new MetricValidator().mean(0.0).max(0.0).min(0.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.SENTIMENT_MONTHLY.value()),
                        new MetricValidator().mean(0.0).max(0.5).min(-0.5)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.SENTIMENT_MONTHLY.value()),
                        new MetricValidator().mean(0.0).max(0.0).min(0.0)
                );

                //revenue
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.REVENUE_DAILY.value()),
                        new MetricValidator().sum(200.0).max(101.0).min(99.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.REVENUE_DAILY.value()),
                        new MetricValidator().sum(101.0).max(101.0).min(101.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_A, HiveDefines.MetricId.REVENUE_MONTHLY.value()),
                        new MetricValidator().sum(200.0).max(101.0).min(99.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02, VALUE_CUSTOM02_B, HiveDefines.MetricId.REVENUE_MONTHLY.value()),
                        new MetricValidator().sum(101.0).max(101.0).min(101.0)
                );
            }
        };
