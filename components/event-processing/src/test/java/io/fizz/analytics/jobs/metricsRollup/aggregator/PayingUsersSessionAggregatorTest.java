...
public class PayingUsersSessionAggregatorTest extends AbstractAggregatorTest {
    @Test
    ...
    void sessionMetricsAggregateTest() {
        ...
        final PayingUsersSessionAggregator aggregator = new PayingUsersSessionAggregator(spark, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY, null);
    ...
    void sessionMetricsCCAggregationTest() {
        ...
        final PayingUsersSessionAggregator aggregator = new PayingUsersSessionAggregator(spark, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_COUNTRY_CODE);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsPlatformAggregationTest() {
        ...
        final PayingUsersSessionAggregator aggregator = new PayingUsersSessionAggregator(spark, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_PLATFORM);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsBuildAggregationTest() {
        ...
        final PayingUsersSessionAggregator aggregator = new PayingUsersSessionAggregator(spark, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_BUILD);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsAgeAggregationTest() {
        ...
        final PayingUsersSessionAggregator aggregator = new PayingUsersSessionAggregator(spark, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_AGE);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsSpendAggregationTest() {
        ...
        final PayingUsersSessionAggregator aggregator = new PayingUsersSessionAggregator(spark, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_SPEND);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsCustom01AggregationTest() {
        ...
        final PayingUsersSessionAggregator aggregator = new PayingUsersSessionAggregator(spark, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_CUSTOM_01);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsSegment02AggregationTest() {
        ...
        final PayingUsersSessionAggregator aggregator = new PayingUsersSessionAggregator(spark, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsCustom03AggregationTest() {
        ...
        final PayingUsersSessionAggregator aggregator = new PayingUsersSessionAggregator(spark, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_CUSTOM_03);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
