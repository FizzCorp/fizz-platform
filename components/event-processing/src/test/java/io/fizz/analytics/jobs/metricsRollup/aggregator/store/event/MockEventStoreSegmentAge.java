...
public class MockEventStoreSegmentAge extends AbstractMockTableDataSource {
    public MockEventStoreSegmentAge(SparkSession aSpark) {
        super(aSpark);
    }
        ...
        return new ArrayList<Row>() {
            {
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("12").setAppId(VALUE_APP_A).setUserId(VALUE_USER_A).setSessionId("session_1")
                        ...
                        .setFields("{\"amount\":99,\"pid\":\"com.test.appa\"}").setAge(VALUE_AGE_A)
                        .setYear("2018").setMonth("5").setDay("8").get());
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("14").setAppId(VALUE_APP_A).setUserId(VALUE_USER_B).setSessionId("session_2")
                        .setType(EventType.PRODUCT_PURCHASED.value()).setVersion(AbstractDomainEvent.VERSION).setOccurredOn(VALUE_MESSAGE_TS)
                        .setPlatform("android").setBuild("build_2").setCustom01("D").setCustom02("E").setCustom03("F")
                        .setFields("{\"amount\":101,\"pid\":\"com.test.appa\"}").setAge(VALUE_AGE_A)
                        .setYear("2018").setMonth("5").setDay("8").get());
                ...
                add(new HiveProfileEnrichedEventTableSchema.RowBuilder().setId("15").setAppId(VALUE_APP_A).setUserId(VALUE_USER_B).setSessionId("session_2")
                        .setType(EventType.PRODUCT_PURCHASED.value()).setVersion(AbstractDomainEvent.VERSION).setOccurredOn(VALUE_MESSAGE_TS)
                        .setPlatform("android").setBuild("build_2").setCustom01("D").setCustom02("E").setCustom03("F")
                        .setFields("{\"amount\":101,\"pid\":\"com.test.appa\"}").setAge(VALUE_AGE_B)
                        .setYear("2018").setMonth("5").setDay("8").get());
    ...
    protected Map<MetricValidator.Key, MetricValidator> validatorsFactory() {
        return new HashMap<MetricValidator.Key,MetricValidator>() {
            {
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.USER_SESSIONS_MONTHLY.value()),
                        new MetricValidator()
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.USER_SESSIONS_MONTHLY.value()),
                        new MetricValidator()
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.ACTIVE_USERS_MONTHLY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.ACTIVE_USERS_MONTHLY.value()),
                        new MetricValidator().count(1.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.USER_SESSIONS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.USER_SESSIONS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.ACTIVE_USERS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.ACTIVE_USERS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );

                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.NEW_USERS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.NEW_USERS_MONTHLY.value()),
                        new MetricValidator().count(2.0)
                );

                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.NEW_USERS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.NEW_USERS_MONTHLY.value()),
                        new MetricValidator().count(1.0)
                );

                //Active Paying User
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );

                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.ACTIVE_PAYING_USER_USERS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );

                //-- actions
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.CHAT_MSGS_DAILY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.CHAT_MSGS_DAILY.value()),
                        new MetricValidator().count(1.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.CHAT_MSGS_MONTHLY.value()),
                        new MetricValidator().count(2.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.CHAT_MSGS_MONTHLY.value()),
                        new MetricValidator().count(1.0)
                );

                //sentiment score mean
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.SENTIMENT_DAILY.value()),
                        new MetricValidator().mean(0.0).max(0.5).min(-0.5)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.SENTIMENT_DAILY.value()),
                        new MetricValidator().mean(0.0).max(0.0).min(0.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.SENTIMENT_MONTHLY.value()),
                        new MetricValidator().mean(0.0).max(0.5).min(-0.5)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.SENTIMENT_MONTHLY.value()),
                        new MetricValidator().mean(0.0).max(0.0).min(0.0)
                );

                //revenue
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.REVENUE_DAILY.value()),
                        new MetricValidator().sum(200.0).max(101.0).min(99.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.REVENUE_DAILY.value()),
                        new MetricValidator().sum(101.0).max(101.0).min(101.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_A, HiveDefines.MetricId.REVENUE_MONTHLY.value()),
                        new MetricValidator().sum(200.0).max(101.0).min(99.0)
                );
                put(
                        new MetricValidator.Key(VALUE_APP_A, HiveDefines.MetricSegments.SEGMENT_AGE, VALUE_AGE_B, HiveDefines.MetricId.REVENUE_MONTHLY.value()),
                        new MetricValidator().sum(101.0).max(101.0).min(101.0)
                );
            }
        };
