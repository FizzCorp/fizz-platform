...
public class AggregationProjectorTest extends AbstractSparkTest {
    ...
    void basicValidityTest() {
        final AggregationProjector projector = new AggregationProjector(new MockTableDataSource(spark), "id", new HiveTime(2018, 4, 16));
        projector.addSink(new MockSink());
        projector.project(Grain.DAILY, new MockTransformer());
    }
}
