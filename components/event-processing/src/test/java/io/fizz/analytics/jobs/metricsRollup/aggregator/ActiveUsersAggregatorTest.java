...
class ActiveUsersAggregatorTest extends AbstractAggregatorTest {
    @Test
    ...
    void sessionMetricsAggregateTest() {
        ...
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_DAILY, null);
    ...
    void sessionMetricsAggregateMonthlyTest() {
        final MockEventStore store = new MockEventStore(spark);
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_MONTHLY, null);
        final Dataset<Row> metricsDS =  aggregator.transform(store.scan(), new HiveTime(2018, 4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsCCAggregationTest() {
        ...
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_COUNTRY_CODE);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsPlatformAggregationTest() {
        ...
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_PLATFORM);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsBuildAggregationTest() {
        ...
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_BUILD);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsAgeAggregationTest() {
        ...
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_AGE);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsSpendAggregationTest() {
        ...
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_SPEND);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsCustom01AggregationTest() {
        ...
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_CUSTOM_01);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsSegment02AggregationTest() {
        ...
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_CUSTOM_02);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
    ...
    void sessionMetricsCustom03AggregationTest() {
        ...
        final ActiveUserAggregator aggregator = new ActiveUserAggregator(HiveDefines.MetricId.ACTIVE_USERS_DAILY, HiveDefines.MetricSegments.SEGMENT_CUSTOM_03);
        final Dataset<Row> metricsDS = aggregator.transform(store.scan(), new HiveTime(2018,4, 16));
        store.validate(metricsDS);
    }
