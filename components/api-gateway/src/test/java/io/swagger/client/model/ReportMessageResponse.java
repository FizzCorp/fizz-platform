...
public class ReportMessageResponse {
  ...
  public ReportMessageResponse id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(description = "Unique identifier of reported message.")
  public String getId() {
    return id;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReportMessageResponse reportMessageResponse = (ReportMessageResponse) o;
    return Objects.equals(this.id, reportMessageResponse.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportMessageResponse {\n");
