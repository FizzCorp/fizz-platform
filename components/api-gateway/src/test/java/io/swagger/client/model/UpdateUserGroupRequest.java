...
public class UpdateUserGroupRequest {
  ...
  public UpdateUserGroupRequest state(Object state) {
    this.state = state;
    return this;
  }

   /**
   * Only &#x27;joined&#x27; state is acceptable.
   * @return state
  **/
  @Schema(description = "Only 'joined' state is acceptable.")
  ...
  public UpdateUserGroupRequest lastReadMessageId(BigDecimal lastReadMessageId) {
    this.lastReadMessageId = lastReadMessageId;
    return this;
  }

   /**
   * Uniquely identifies the last message read by the user.
   * minimum: 0
   * @return lastReadMessageId
  **/
  @Schema(description = "Uniquely identifies the last message read by the user.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.state, updateUserGroupRequest.state) &&
        Objects.equals(this.lastReadMessageId, updateUserGroupRequest.lastReadMessageId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(state, lastReadMessageId);
  }
