...
/**
 * The state of the membership of a user in a group.
 */
@JsonAdapter(GroupMemberState.Adapter.class)
public enum GroupMemberState {
  ...
  public static GroupMemberState fromValue(String text) {
    for (GroupMemberState b : GroupMemberState.values()) {
  ...
  public static class Adapter extends TypeAdapter<GroupMemberState> {
    @Override
    public void write(final JsonWriter jsonWriter, final GroupMemberState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public GroupMemberState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return GroupMemberState.fromValue(String.valueOf(value));
    }
  }
}
