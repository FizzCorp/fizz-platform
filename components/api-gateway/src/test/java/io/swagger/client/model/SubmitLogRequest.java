...
public class SubmitLogRequest {
  ...
  private String logItem = null;

  public SubmitLogRequest logItem(String logItem) {
   ...
   * @return logItem
  **/
  @Schema(description = "Message string to be logged.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubmitLogRequest submitLogRequest = (SubmitLogRequest) o;
    return Objects.equals(this.logItem, submitLogRequest.logItem);
  }

  @Override
  public int hashCode() {
    return Objects.hash(logItem);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubmitLogRequest {\n");
    
    sb.append("    logItem: ").append(toIndentedString(logItem)).append("\n");
    sb.append("}");
    return sb.toString();
  }
