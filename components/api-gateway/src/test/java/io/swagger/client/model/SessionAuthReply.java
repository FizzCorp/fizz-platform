...
public class SessionAuthReply {
  ...
  private BigDecimal nowTs = null;

  public SessionAuthReply token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public SessionAuthReply subscriberId(String subscriberId) {
    this.subscriberId = subscriberId;
    return this;
  }

   /**
   * Uniquely identifies the enitity&#x27;s subscription.
   * @return subscriberId
  **/
  @Schema(description = "Uniquely identifies the enitity's subscription.")
  ...
  public SessionAuthReply nowTs(BigDecimal nowTs) {
    this.nowTs = nowTs;
    return this;
  }
   ...
   * @return nowTs
  **/
  @Schema(required = true, description = "Current server time")
  public BigDecimal getNowTs() {
    return nowTs;
  }

  public void setNowTs(BigDecimal nowTs) {
    this.nowTs = nowTs;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SessionAuthReply sessionAuthReply = (SessionAuthReply) o;
    return Objects.equals(this.token, sessionAuthReply.token) &&
        Objects.equals(this.subscriberId, sessionAuthReply.subscriberId) &&
        Objects.equals(this.nowTs, sessionAuthReply.nowTs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, subscriberId, nowTs);
  }
  ...
  public String toString() {
    ...
    sb.append("class SessionAuthReply {\n");
    
    sb.append("    token: ").append(toIndentedString(token)).append("\n");
    sb.append("    subscriberId: ").append(toIndentedString(subscriberId)).append("\n");
    sb.append("    nowTs: ").append(toIndentedString(nowTs)).append("\n");
    sb.append("}");
    return sb.toString();
  }
