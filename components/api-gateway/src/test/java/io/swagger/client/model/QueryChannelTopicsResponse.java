...
/**
 * List of channel topic ids.
 */
@Schema(description = "List of channel topic ids.")
...
public class QueryChannelTopicsResponse extends ArrayList<String> {
  ...
  public String toString() {
    ...
    sb.append("class QueryChannelTopicsResponse {\n");
