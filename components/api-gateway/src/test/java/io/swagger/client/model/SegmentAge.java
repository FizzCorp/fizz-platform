...
/**
 * Gets or Sets SegmentAge
 */
@JsonAdapter(SegmentAge.Adapter.class)
public enum SegmentAge {
  ...
  public static SegmentAge fromValue(String text) {
    for (SegmentAge b : SegmentAge.values()) {
  ...
  public static class Adapter extends TypeAdapter<SegmentAge> {
    @Override
    public void write(final JsonWriter jsonWriter, final SegmentAge enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SegmentAge read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SegmentAge.fromValue(String.valueOf(value));
    }
  }
}
