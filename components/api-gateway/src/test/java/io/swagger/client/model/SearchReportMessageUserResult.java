...
public class SearchReportMessageUserResult {
  ...
  public SearchReportMessageUserResult userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  **/
  ...
  public SearchReportMessageUserResult count(BigDecimal count) {
    this.count = count;
    return this;
  }

   /**
   * No of reported message of the user.
   * @return count
  **/
  @Schema(example = "10", required = true, description = "No of reported message of the user.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SearchReportMessageUserResult searchReportMessageUserResult = (SearchReportMessageUserResult) o;
    return Objects.equals(this.userId, searchReportMessageUserResult.userId) &&
        Objects.equals(this.count, searchReportMessageUserResult.count);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchReportMessageUserResult {\n");
