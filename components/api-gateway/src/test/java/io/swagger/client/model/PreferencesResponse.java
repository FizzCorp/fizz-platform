...
public class PreferencesResponse {
  @SerializedName("force_content_moderation")
  private Boolean forceContentModeration = false;

  public PreferencesResponse forceContentModeration(Boolean forceContentModeration) {
    this.forceContentModeration = forceContentModeration;
    return this;
  }

   /**
   * Force content filtering of all chat messages.
   * @return forceContentModeration
  **/
  @Schema(description = "Force content filtering of all chat messages.")
  public Boolean isForceContentModeration() {
    return forceContentModeration;
  }

  public void setForceContentModeration(Boolean forceContentModeration) {
    this.forceContentModeration = forceContentModeration;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PreferencesResponse preferencesResponse = (PreferencesResponse) o;
    return Objects.equals(this.forceContentModeration, preferencesResponse.forceContentModeration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(forceContentModeration);
  }
  ...
  public String toString() {
    ...
    sb.append("class PreferencesResponse {\n");
    
    sb.append("    forceContentModeration: ").append(toIndentedString(forceContentModeration)).append("\n");
    sb.append("}");
    return sb.toString();
  }
