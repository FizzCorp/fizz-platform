 ...
 */
@JsonAdapter(ComparisonOp.Adapter.class)
public enum ComparisonOp {
  ...
  public static ComparisonOp fromValue(String text) {
    for (ComparisonOp b : ComparisonOp.values()) {
  ...
  public static class Adapter extends TypeAdapter<ComparisonOp> {
    @Override
    public void write(final JsonWriter jsonWriter, final ComparisonOp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ComparisonOp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ComparisonOp.fromValue(String.valueOf(value));
    }
  }
}
