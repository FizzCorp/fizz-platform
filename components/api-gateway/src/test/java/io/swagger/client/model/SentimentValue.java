...
/**
 * This is a dynamic value based of given &#x27;op&#x27; value. 1) it will be json if &#x27;op&#x27; value is &#x27;btw&#x27; 2) it will be &#x27;double&#x27; in case of all other &#x27;op&#x27; values.
 */
@Schema(description = "This is a dynamic value based of given 'op' value. 1) it will be json if 'op' value is 'btw' 2) it will be 'double' in case of all other 'op' values.")
...
public class SentimentValue extends HashMap<String, Object> {
  ...
  public String toString() {
    ...
    sb.append("class SentimentValue {\n");
