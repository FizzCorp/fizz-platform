...
import io.swagger.client.model.SearchReportMessageResultData;
...
public class SearchReportMessageResult {
  @SerializedName("data")
  private List<SearchReportMessageResultData> data = new ArrayList<SearchReportMessageResultData>();

  @SerializedName("total_size")
  private BigDecimal totalSize = null;

  public SearchReportMessageResult data(List<SearchReportMessageResultData> data) {
    this.data = data;
    return this;
  }

  public SearchReportMessageResult addDataItem(SearchReportMessageResultData dataItem) {
  ...
  **/
  ...
  public List<SearchReportMessageResultData> getData() {
    return data;
  }

  public void setData(List<SearchReportMessageResultData> data) {
    this.data = data;
  }

  public SearchReportMessageResult totalSize(BigDecimal totalSize) {
    this.totalSize = totalSize;
    return this;
  }

   /**
   * Total result size against the query.
   * @return totalSize
  **/
  @Schema(required = true, description = "Total result size against the query.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SearchReportMessageResult searchReportMessageResult = (SearchReportMessageResult) o;
    return Objects.equals(this.data, searchReportMessageResult.data) &&
        Objects.equals(this.totalSize, searchReportMessageResult.totalSize);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, totalSize);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchReportMessageResult {\n");
