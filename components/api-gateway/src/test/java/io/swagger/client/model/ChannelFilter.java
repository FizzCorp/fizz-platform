...
public class ChannelFilter {
  ...
  public ChannelFilter startsWith(String startsWith) {
    this.startsWith = startsWith;
    return this;
  }

   /**
   * Any channel Id which starts with given string
   * @return startsWith
  **/
  @Schema(description = "Any channel Id which starts with given string")
  ...
  public ChannelFilter matches(String matches) {
    this.matches = matches;
    return this;
  }

   /**
   * Channel Id should match with given string
   * @return matches
  **/
  @Schema(description = "Channel Id should match with given string")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ChannelFilter channelFilter = (ChannelFilter) o;
    return Objects.equals(this.startsWith, channelFilter.startsWith) &&
        Objects.equals(this.matches, channelFilter.matches);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startsWith, matches);
  }
