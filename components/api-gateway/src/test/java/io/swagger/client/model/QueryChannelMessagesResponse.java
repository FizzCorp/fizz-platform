...
import io.swagger.client.model.ChannelMessage;
...
public class QueryChannelMessagesResponse extends ArrayList<ChannelMessage> {
  ...
  public String toString() {
    ...
    sb.append("class QueryChannelMessagesResponse {\n");
