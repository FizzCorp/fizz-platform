...
/**
 * Gets or Sets SegmentSpender
 */
@JsonAdapter(SegmentSpender.Adapter.class)
public enum SegmentSpender {
  NONE("none"),
  MINNOW("minnow"),
  DOLPHIN("dolphin"),
  WHALE("whale");
  ...
  public static SegmentSpender fromValue(String text) {
    for (SegmentSpender b : SegmentSpender.values()) {
  ...
  public static class Adapter extends TypeAdapter<SegmentSpender> {
    @Override
    public void write(final JsonWriter jsonWriter, final SegmentSpender enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SegmentSpender read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SegmentSpender.fromValue(String.valueOf(value));
    }
  }
}
