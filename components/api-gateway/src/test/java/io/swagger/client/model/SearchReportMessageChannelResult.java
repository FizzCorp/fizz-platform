...
public class SearchReportMessageChannelResult {
  ...
  public SearchReportMessageChannelResult channelId(String channelId) {
  ...
  **/
  ...
  public SearchReportMessageChannelResult count(BigDecimal count) {
    this.count = count;
    return this;
  }

   /**
   * No of reported message in the channel.
   * @return count
  **/
  @Schema(example = "10", required = true, description = "No of reported message in the channel.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SearchReportMessageChannelResult searchReportMessageChannelResult = (SearchReportMessageChannelResult) o;
    return Objects.equals(this.channelId, searchReportMessageChannelResult.channelId) &&
        Objects.equals(this.count, searchReportMessageChannelResult.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelId, count);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchReportMessageChannelResult {\n");
