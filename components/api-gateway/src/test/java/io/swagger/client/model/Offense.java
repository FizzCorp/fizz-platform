 ...
 * Type of offense.
 */
@JsonAdapter(Offense.Adapter.class)
public enum Offense {
  SPAM("Spam"),
  TOXIC("Toxic"),
  ...
  public static Offense fromValue(String text) {
    for (Offense b : Offense.values()) {
  ...
  public static class Adapter extends TypeAdapter<Offense> {
    @Override
    public void write(final JsonWriter jsonWriter, final Offense enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Offense read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Offense.fromValue(String.valueOf(value));
    }
  }
}
