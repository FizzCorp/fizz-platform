...
public class TranslatedText {
  ...
  public TranslatedText to(String to) {
    this.to = to;
    return this;
  }
   ...
   * @return to
  **/
  @Schema(description = "The target language of the translation.")
  public String getTo() {
    return to;
  }
  ...
  public TranslatedText text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TranslatedText translatedText = (TranslatedText) o;
    return Objects.equals(this.to, translatedText.to) &&
        Objects.equals(this.text, translatedText.text);
  }
  ...
  public String toString() {
    ...
    sb.append("class TranslatedText {\n");
