...
import io.swagger.client.model.AllowedChannels;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * The update session information.
 */
@Schema(description = "The update session information.")
...
public class UpdateSessionAuthRequest {
  ...
  private AllowedChannels channels = null;

  public UpdateSessionAuthRequest appId(String appId) {
    this.appId = appId;
    return this;
  }
  ...
  **/
  ...
  public UpdateSessionAuthRequest token(String token) {
    this.token = token;
    return this;
  }
   ...
   * @return token
  **/
  @Schema(required = true, description = "Session token.")
  ...
  public UpdateSessionAuthRequest channels(AllowedChannels channels) {
  ...
  **/
  @Schema(description = "")
  public AllowedChannels getChannels() {
    return channels;
  }

  public void setChannels(AllowedChannels channels) {
    this.channels = channels;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateSessionAuthRequest updateSessionAuthRequest = (UpdateSessionAuthRequest) o;
    return Objects.equals(this.appId, updateSessionAuthRequest.appId) &&
        Objects.equals(this.token, updateSessionAuthRequest.token) &&
        Objects.equals(this.channels, updateSessionAuthRequest.channels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appId, token, channels);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSessionAuthRequest {\n");
