...
import io.swagger.client.model.ProviderType;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * ProviderConfigResponse2
 */
...
public class ProviderConfigResponse2 {
  @SerializedName("type")
  private ProviderType type = null;
  ...
  @SerializedName("cp_app_id")
  private String cpAppId = null;

  public ProviderConfigResponse2 type(ProviderType type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public ProviderConfigResponse2 baseUrl(String baseUrl) {
  ...
  **/
  ...
  public ProviderConfigResponse2 secret(String secret) {
    this.secret = secret;
    return this;
  }
  ...
  **/
  ...
  public ProviderConfigResponse2 cpAppId(String cpAppId) {
    this.cpAppId = cpAppId;
    return this;
  }

   /**
   * App Id (cleanspeak specific)
   * @return cpAppId
  **/
  @Schema(description = "App Id (cleanspeak specific)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProviderConfigResponse2 providerConfigResponse2 = (ProviderConfigResponse2) o;
    return Objects.equals(this.type, providerConfigResponse2.type) &&
        Objects.equals(this.baseUrl, providerConfigResponse2.baseUrl) &&
        Objects.equals(this.secret, providerConfigResponse2.secret) &&
        Objects.equals(this.cpAppId, providerConfigResponse2.cpAppId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, baseUrl, secret, cpAppId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProviderConfigResponse2 {\n");
    
    sb.append("    type: ").append(toIndentedString(type)).append("\n");
    sb.append("    baseUrl: ").append(toIndentedString(baseUrl)).append("\n");
    sb.append("    secret: ").append(toIndentedString(secret)).append("\n");
    sb.append("    cpAppId: ").append(toIndentedString(cpAppId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
