...
import io.swagger.client.model.ChannelFilter;
import io.swagger.v3.oas.annotations.media.Schema;
import java.util.ArrayList;
import java.util.List;
/**
 * The list of allowed channels in the session. Set to &#x27;null&#x27; to allow all channels.
 */
@Schema(description = "The list of allowed channels in the session. Set to 'null' to allow all channels.")
...
public class AllowedChannels extends ArrayList<ChannelFilter> {
  ...
  public String toString() {
    ...
    sb.append("class AllowedChannels {\n");
