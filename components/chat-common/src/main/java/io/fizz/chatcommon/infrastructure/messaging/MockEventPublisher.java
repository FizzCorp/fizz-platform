...
public class MockEventPublisher implements AbstractEventPublisher {
    ...
    public MockEventPublisher(final AbstractEventSerde aSerde, final DomainEventType[] aListenedEvents) {
